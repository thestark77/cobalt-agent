...
ORCHESTRATOR_ALLOWED = frozenset({
    ...
    # Ghostfolio investments MCP (Phase 4) — reads + writes direct (no sub-agent
    # hop). The 8 writers are also in incognito.WRITE_TOOLS.
    "mcp_ghostfolio_get_accounts",
    "mcp_ghostfolio_get_account_balances",
    "mcp_ghostfolio_get_asset_profile",
    "mcp_ghostfolio_get_market_data_for_asset",
    "mcp_ghostfolio_get_orders",
    "mcp_ghostfolio_get_portfolio_details",
    "mcp_ghostfolio_get_dividends",
    "mcp_ghostfolio_get_portfolio_holdings",
    "mcp_ghostfolio_get_investments",
    "mcp_ghostfolio_get_portfolio_performance",
    "mcp_ghostfolio_get_position",
    "mcp_ghostfolio_get_symbol_data",
    "mcp_ghostfolio_get_historical_data",
    "mcp_ghostfolio_lookup_symbols",
    "mcp_ghostfolio_get_user_info",
    "mcp_ghostfolio_get_health",
    "mcp_ghostfolio_get_platforms",
