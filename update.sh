...
PLUGIN_FILES=(
  ...
  "memory_protocol.py" "markitdown_protocol.py" "incognito.py" "iris_protocol.py" "finance_protocol.py" "reconcile.py" "karakeep_protocol.py" "ghostfolio_protocol.py" "calendar_protocol.py" "iris_capture.py" "firewall.py"
